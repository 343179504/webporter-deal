...
public class ImDriver {
    ...
    public void init(){
        ...
        options.setExperimentalOption("debuggerAddress", webporterConfig.getImty_listenAddress());
        ...
        try{
            ...
            try{
                if ("大".equals(daxiaoqiu)) {
                    WebElement daqiu = driver.findElements(By.xpath("//div[text()='"+name+"']//ancestor::div[@class='event_row']//div[@class='event_even'][5]")).get(0).findElements(By.xpath("div/span")).get(0);


                    this.javaScriptClick(daqiu);

                } else if ("小".equals(daxiaoqiu)) {
                    WebElement xiaoqiu = driver.findElements(By.xpath("//div[text()='"+name+"']//ancestor::div[@class='event_row']//div[@class='event_even'][5]")).get(0).findElements(By.xpath("div/span")).get(1);
